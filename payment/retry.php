<?php
/**
 * Retry payment for an existing order whose payment previously failed or
 * wasn't completed. The order and its items already exist; this page just
 * fires a new request to Zarinpal.
 */
